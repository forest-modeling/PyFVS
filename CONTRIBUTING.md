...
Welcome to `PyFVS` contributor's guide.

**This guides boilerplate from PyScaffold and is most likely not terribly useful**
...
If you experience bugs or general issues with `PyFVS`, please have a look
...
You can help improve `PyFVS` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`PyFVS` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `PyFVS`'s files. While this mechanism can
...
```
conda create -n PyFVS python=3 six virtualenv pytest pytest-cov
conda activate PyFVS
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/PyFVS.git
   cd PyFVS
   ```
...
5. Install [pre-commit]:
   ...
   `PyFVS` comes with a lot of hooks configured to automatically help the
...
[issue tracker]: https://github.com/forest-modeling/PyFVS/issues
