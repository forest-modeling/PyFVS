...
!C    CLMRTMLT1    = SPECIES-SPECIFIC MORTALITY MULTIPLIERS
!C    CLMRTMLT2    =
!C    CLMXDENMULT  = MODIFIES THE MAGNITUDE OF THE MAX DENSITY EFFECTS.
!C    CLIMATE_NAME = THE GSM/SCENARIO NAME
!C    IDEmtwm,IDEmtcm,IDEdd5,IDEsdi,IDEdd0,IDEmapdd5=POINTS TO THE COLUMN
!C                   WHERE THE CHANGE OVER 300 M RANGE IN THESE VARIABLES
!C                   IS STORED.
...
!C    IXMTWM       = POINTS TO THE COLUMN WHERE mtwm IS STORED
