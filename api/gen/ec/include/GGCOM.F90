...
!C COMMON $Id$
!C----------
!C  THIS COMMON BLOCK CONTAINS VARIABLES UNIQUE TO THE
!C  VARIANT DERIVED FROM THE GENGYM G&Y MODEL.
!C----------
!C
      INTEGER IGFOR
!C
...
!C     SITEHI -- UPPER END OF THE VALID SITE INDEX RANGE FOR A SPECIES.
!C     SITELO -- LOWER END OF THE VALID SITE INDEX RANGE FOR A SPECIES.
