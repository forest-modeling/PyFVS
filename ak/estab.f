...
C
      ...
      CHARACTER*3  FINAL
C
      INTEGER I,IACTK,IBRKUP,IDO,IDUP,IEND,IEVTYR,II,INGRO,IPNSPE,M
...
C
      ...
      REAL TTOTTP,WBLADJ,WBLMAX,XCSMAX,XH,XXH,ZHARV,WTAVEHT
...
C
 ...
 6013   FORMAT(/,T3,'SITE PREP SUMMARY',T38,'PLOT HABITAT TYPE SUMMARY',
     ...
     &  '15 16',/,T2,'PCT:',I4,2I5,'   #PLOTS:',I2,15I3)
        IF(IREG2.EQ.1)CALL DBSSITEPREP(J,K,L,N,NN,ITEMP)
        IF(IREG3.EQ.1)THEN
        DO M=1,16
 ...
 6014 FORMAT(T9,A2,2X,2F6.0,4X,2F6.0,1X,F5.1,6X,2F6.0,3X,A2)
      ...
      IF (IREG4.EQ.1) CALL DBSTALLY(SUMPRB,NTALLY,NSP(I,1),TOTTPA(I),
     & TOTPCT(I),BESTPA(I),BESPCT(I),AVEHT(I),PASTPA(I),PASPCT(I),KDT,
     & WTAVEHT,1,TTOTTP,TCROP1,TCROP2)
  222 CONTINUE
      WTAVEHT=WTAVEHT/TCROP1
      IF (IREG4.EQ.1) CALL DBSTALLY(SUMPRB,NTALLY,FINAL,TOTTPA(I),
     & TOTPCT(I),BESTPA(I),BESPCT(I),AVEHT(I),PASTPA(I),PASPCT(I),KDT,
